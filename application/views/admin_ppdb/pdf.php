...
$filename_pdf = 'bukti-ppdb-'.preg_replace('/[^0-9A-Za-z_-]/', '', $p->nisn ?? 'peserta').'.pdf';
?>
        ...
        <div class="identity-box">
            <table class="identity-table">
                <tr>
                    ...
                    <td>: <?= pdf_value($p->no_pendaftaran ?? '') ?></td>
                </tr>
                <tr>
                    <td>Nama Lengkap</td>
                    <td>: <?= pdf_value($p->nama_lengkap ?? '') ?></td>
                </tr>
                <tr>
                    <td>NISN</td>
                    <td>: <?= pdf_value($p->nisn ?? '') ?></td>
                </tr>
                <tr>
                    <td>Status</td>
                    <td>:
...
<tr><th>Nama Lengkap</th><td><?= pdf_value($p->nama_lengkap ?? '') ?></td></tr>
<tr><th>NISN</th><td><?= pdf_value($p->nisn ?? '') ?></td></tr>
<tr><th>TTL</th><td><?= pdf_value($p->tempat_lahir ?? '') ?>, <?= pdf_tanggal($p->tanggal_lahir ?? '') ?></td></tr>
<tr><th>Jenis Kelamin</th><td><?= ($p->jk ?? '') == 'L' ? 'Laki-laki' : (($p->jk ?? '') == 'P' ? 'Perempuan' : '-') ?></td></tr>
<tr><th>Asal Sekolah</th><td><?= pdf_value($p->asal_sekolah ?? '') ?></td></tr>
<tr><th>No HP</th><td><?= pdf_value($p->no_hp ?? '') ?></td></tr>
</table>
...
<table class="data-table">
<tr><th>NIK</th><td><?= pdf_value($p->nik ?? '') ?></td></tr>
<tr><th>No KK</th><td><?= pdf_value($p->no_kk ?? '') ?></td></tr>
<tr><th>Agama</th><td><?= pdf_value($p->agama ?? '') ?></td></tr>
<tr><th>Anak Ke</th><td><?= pdf_value($p->anak_ke ?? '') ?></td></tr>
<tr><th>Jumlah Saudara</th><td><?= pdf_value($p->jumlah_saudara ?? '') ?></td></tr>
</table>
...
<tr>
    ...
    <td>
        <?= pdf_value($p->alamat ?? '') ?>,
        RT <?= pdf_value($p->rt ?? '') ?>/RW <?= pdf_value($p->rw ?? '') ?>,
        <?= pdf_value($p->desa ?? '') ?>,
        <?= pdf_value($p->kecamatan ?? '') ?>,
        <?= pdf_value($p->kabupaten ?? '') ?>,
        <?= pdf_value($p->provinsi ?? '') ?>,
        <?= pdf_value($p->kode_pos ?? '') ?>
    </td>
</tr>
</table>
...
<table class="data-table">
<tr><th>Nama Ayah</th><td><?= pdf_value($p->nama_ayah ?? '') ?></td></tr>
<tr><th>Pekerjaan Ayah</th><td><?= pdf_value($p->pekerjaan_ayah ?? '') ?></td></tr>
<tr><th>Nama Ibu</th><td><?= pdf_value($p->nama_ibu ?? '') ?></td></tr>
<tr><th>Pekerjaan Ibu</th><td><?= pdf_value($p->pekerjaan_ibu ?? '') ?></td></tr>
<tr><th>Penghasilan Orang Tua</th><td><?= pdf_value($p->penghasilan_ortu ?? '') ?></td></tr>
</table>
...
<div class="note">
    <b>Catatan:</b>
    Surat Keterangan Kelas 9 termasuk berkas wajib. Ijazah juga wajib dilampirkan (bisa berupa ijazah SD/MI atau ijazah terakhir).
