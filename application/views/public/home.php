...
<header class="web-hero">
    <div class="container">
        ...
        <div class="web-hero-actions">
            ...
            <a href="<?= base_url('verifikasi_foto_ijazah') ?>" class="web-btn web-btn-outline" style="border-color: rgba(255,255,255,0.4);">
                <i class="bi bi-mortarboard-fill text-warning me-1"></i> Foto Ijazah XII
            </a>
        ...
        <div class="row g-4 mb-5">
            ...
            <div class="col-lg-3 col-md-6">
                ...
                <ul class="list-unstyled" style="display: flex; flex-direction: column; gap: 12px; margin: 0;">
                    ...
                    <li><a href="<?= base_url('website/berita') ?>" style="color: rgba(255,255,255,0.7); text-decoration: none; transition: all 0.2s; display: flex; align-items: center; gap: 8px;" onmouseover="this.style.color='#fff'; this.style.paddingLeft='5px'" onmouseout="this.style.color='rgba(255,255,255,0.7)'; this.style.paddingLeft='0'"><i class="bi bi-chevron-right" style="font-size: 10px;"></i> Berita Madrasah</a></li>
                </ul>
            </div>
